...
#if !defined(HAVE_POSIX_THREADS) && !defined(HAVE_WIN32_THREADS)
#   error Environment must support POSIX or WIN32 threads.
#endif
...
//
// This class represents a thread id under POSIX threads
//
class JTCThreadId
{
public:
    ...
    //
    bool
    operator!=(const JTCThreadId& rhs) const
    {
	return !(*this == rhs);
    }
    ...
    operator<<(JTC_STD(ostream)&, const JTCThreadId&);
...
//
class JTC_IMPORT_EXPORT JTCThreadId
{
public:

...
#define MIME_IMAGE_ICO		"image/x-icon"

//parameter string constants for cmd values
#define PARAM_COMMAND_VALUE_GLOBAL_HISTORY_STR	"1"
#define PARAM_COMMAND_VALUE_SCHEDULE_COMMAND_STR	"4"

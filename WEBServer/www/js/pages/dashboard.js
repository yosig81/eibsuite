App.registerPage('dashboard', {
    ...
    render: function(container) {
        container.innerHTML =
            ...
            '<div class="stats-grid" id="dash-stats">' +
                ...
                '<div class="stat-card"><div class="stat-value" id="dash-console-status">--</div><div class="stat-label">Console Manager</div></div>' +
    ...
    refresh: function() {
        ...
        App.api('GET', '/api/admin/interface').then(function(data) {
            ...
            var cel = document.getElementById('dash-console-status');
            if (el) {
                if (data.error) {
                    el.textContent = '?';
